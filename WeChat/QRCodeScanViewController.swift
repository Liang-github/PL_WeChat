...
class QRCodeScanViewController: UIViewController{
  ...
  @objc  func choosePicFromPhotoLib(sender:UIBarButtonItem){
    ...
    private func setUpUI(){
        ...
        customContainerView = UIView(frame: CGRect(x:0, y:0, width:UIScreen.main.bounds.width-100, height:UIScreen.main.bounds.width-100))
        customContainerView.center = self.view.center;
        customContainerView.clipsToBounds = true
        view.addSubview(customContainerView)
        
        
        customLabel = UILabel(frame: CGRect(x:0, y:64+20, width:UIScreen.main.bounds.width, height:40))
        ...
        customTabbar = UITabBar(frame: CGRect(x:0, y:(UIScreen.main.bounds.height-49), width:UIScreen.main.bounds.width, height:49))
